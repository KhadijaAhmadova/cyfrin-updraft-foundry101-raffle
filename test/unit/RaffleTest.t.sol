...
contract RaffleTest is Test, CodeConstants {
    ...
    function testRaffleRevertsIfNotEnoughEntranceFeePayed() public {
        vm.prank(PLAYER);
        vm.expectRevert(Raffle.Raffle__ValueSentIsLessThanEntranceFee.selector);
        raffle.enterRaffle();
    }

    function testPlayersCantEnterIfRaffleStateIsNotOpen() public {
        vm.prank(PLAYER);
    ...
    // testCheckUpkeedpReturnsTrueWhenParametersAreGood
